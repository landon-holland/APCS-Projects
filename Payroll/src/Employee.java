...
public class Employee {
    ...
    public Employee(char r) throws IOException {
        // Declare FileReaders
        FileReader lnreader = new FileReader("D:\\AP CS\\Project Files\\Payroll\\src\\lastnames.txt");
        FileReader fnreader = new FileReader("D:\\AP CS\\Project Files\\Payroll\\src\\firstnames.txt");
        FileReader mnreader = new FileReader("D:\\AP CS\\Project Files\\Payroll\\src\\middlenames.txt");
        ...
        // Time to deal with unique id's
        File idfile = new File("E:\\AP CS\\Project Files\\Payroll\\src\\id.txt");
        Scanner idscanner = new Scanner(idfile);

        id = idscanner.nextInt() + 1;

        PrintWriter idwriter = new PrintWriter("E:\\AP CS\\Project Files\\Payroll\\src\\id.txt");
        idwriter.print(id);
        idwriter.close();
    }
